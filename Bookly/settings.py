...
# Load .env at project root (BASE_DIR)
...
# Authentication backends: allow username or email login
...
# Flow sandbox configuration (https://web.sandbox.flow.cl/es-cl/)
# Provide via environment variables in production
FLOW_BASE_URL = os.getenv('FLOW_BASE_URL', 'https://sandbox.flow.cl/api')
FLOW_API_KEY = os.getenv('FLOW_API_KEY', '')
FLOW_SECRET = os.getenv('FLOW_SECRET', '')
FLOW_COMMERCE_ID = os.getenv('FLOW_COMMERCE_ID', '')

# Used to build absolute return/callback URLs
